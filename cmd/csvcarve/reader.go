// Slitely modifed reader copied from https://go.dev/src/encoding/csv/reader.go
// I wanted to have the raw line to output and not a joined slice
package main
